...
Since there is variance in accuracy of different models, let us try to create an ensemble of all these models and see if we can improve the accuracy. What strategy could possibility be best fitting for this situation?
