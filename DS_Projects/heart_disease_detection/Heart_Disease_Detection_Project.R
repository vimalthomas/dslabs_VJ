...
#
#The Model generation code consists of the following moduels
#1) Library Management
#2) Function Loading
#3) Data Preperation
#4) Data Analysis and Visualization
#5) Scaling, PCA & Cluster Analysis
#6) Creationg of training and testing datasets
#7) Machine Learning Model generation
#8) Creation of Ensamble 
#######################################
## 1. Library Management
#######################################
...
#there are totally 6 rows in the entire dataset with the presense of missing values.
...
#To do that, let us look at the summary of the features to see what values do we deal with.
...
#As taught in the course, let us see if scaling this dataset makes any difference in their variance propoertions.
#One way to findout if scaling is rquired, is by conducting PCA.
...
#since this is a classificaiton problem of DISEASE and NOT DISEASE, let us try k-means, logistic regression, classificaiton treas and random forest 

#Model 1 : k-means clustering model
#----------------------------------

#similar to an excercise taugth in the course, let us write a function for kmeans.
...
#based on the dataframe, use the models to generate an ensamble model for the disease prediction.
